...
publish-images-ci:
	...
	${IMAGES_BUILD_TOOL} ${DOCKER_PUSH_COMMAND} ${DOCKER_HUB_CP_BASE_NEW_IMAGE}
	${IMAGES_BUILD_TOOL} ${DOCKER_PUSH_COMMAND} ${DOCKER_HUB_CP_BASE_NEW_LATEST}
	${IMAGES_BUILD_TOOL} tag ${DOCKER_HUB_CP_KERBEROS_IMAGE} ${DOCKER_HUB_CP_KERBEROS_LATEST}
	${IMAGES_BUILD_TOOL} ${DOCKER_PUSH_COMMAND} ${DOCKER_HUB_CP_KERBEROS_IMAGE}
	${IMAGES_BUILD_TOOL} ${DOCKER_PUSH_COMMAND} ${DOCKER_HUB_CP_KERBEROS_LATEST}
	${IMAGES_BUILD_TOOL} tag ${DOCKER_HUB_CP_JMXTERM_IMAGE} ${DOCKER_HUB_CP_JMXTERM_LATEST}
	${IMAGES_BUILD_TOOL} ${DOCKER_PUSH_COMMAND} ${DOCKER_HUB_CP_JMXTERM_IMAGE}
	${IMAGES_BUILD_TOOL} ${DOCKER_PUSH_COMMAND} ${DOCKER_HUB_CP_JMXTERM_LATEST}
