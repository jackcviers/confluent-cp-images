...
DOCKER_HUB_CP_BASE_NEW_ARM_64_IMAGE = ${DOCKER_PROTOCOL}docker.io/jackcviers/${CP_BASE_NEW_COMPONENT}:${ARM_64_TAG}
...
DOCKER_HUB_CP_KERBEROS_ARM_64_IMAGE = ${DOCKER_PROTOCOL}docker.io/jackcviers/${CP_KERBEROS_COMPONENT}:${ARM_64_TAG}
