...
@test "git git build-essential zlib1g zlib1g-dev curl openssl libssl-dev libsasl2-dev libsasl2-2 sasl2-bin pkg-config lz4 wget tar findutils should be installed" {
    run unbuffer ${BATS_BUILD_TOOL} exec -it cp-kafkacat-test-${ARCH} apt list git build-essential zlib1g zlib1g-dev curl openssl libssl-dev libsasl2-dev libsasl2-2 sasl2-bin pkg-config lz4 wget tar findutils --installed
    assert_output --partial "git"
    assert_output --partial "build-essential"
    assert_output --partial "zlib1g"
    assert_output --partial "zlib1g-dev"
    assert_output --partial "curl"
    assert_output --partial "openssl"
    assert_output --partial "libssl-dev"
    assert_output --partial "libsasl2-2"
    assert_output --partial "libsasl2-dev"
    assert_output --partial "sasl2-bin"
    assert_output --partial "pkg-config"
    assert_output --partial "lz4"
    assert_output --partial "wget"
    assert_output --partial "tar"
    assert_output --partial "findutils"
}

# @test "/var/lib/zookeeper should be owned by appuser:root" {
#     run bash -c "unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} stat -c '%U' /var/lib/zookeeper"
#     assert_output --partial "appuser"
#     run bash -c "unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} stat -c '%G' /var/lib/zookeeper"
#     assert_output --partial "root"
# }

# @test "package confluent-kafka should be installed" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "apt list confluent-kafka --installed" 3>&-
#     assert_output --partial "confluent-kafka"
# }

# @test "/var/lib/zookeeper/data should exist" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "[ -d \"/var/lib/zookeeper/data\" ]" 3>&-
#     assert_success
# }

# @test "/var/lib/zookeeper/data should be owned by appuser:root and have 775 permissions" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/var/lib/zookeeper/data\""
#     assert_output --partial "appuser"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%G\" \"/var/lib/zookeeper/data\""
#     assert_output --partial "root"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "ls -ld /var/lib/zookeeper/data"
#     assert_output --partial "drwxrwxrw-"
# }

# @test "/var/lib/zookeeper/log should be owned by appuser:root and have 775 permissions" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/var/lib/zookeeper/log\""
#     assert_output --partial "appuser"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%G\" \"/var/lib/zookeeper/log\""
#     assert_output --partial "root"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "ls -ld /var/lib/zookeeper/log"
#     assert_output --partial "drwxrwxrw-"
# }

# @test "/etc/zookeeper/secrets should be owned by appuser:root and have 775 permissions" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/zookeeper/secrets\""
#     assert_output --partial "appuser"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%G\" \"/etc/zookeeper/secrets\""
#     assert_output --partial "root"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "ls -ld /etc/zookeeper/secrets"
#     assert_output --partial "drwxrwxrw-"
# }

# @test "/etc/kafka should be owned by appuser:root and have 775 permissions" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/kafka\""
#     assert_output --partial "appuser"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%G\" \"/etc/kafka\""
#     assert_output --partial "root"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "ls -ld /etc/kafka"
#     assert_output --partial "drwxrwxrw-"
# }
	
# @test "/var/log/kafka should be owned by appuser:root and have 770 permissions" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/var/log/kafka\""
#     assert_output --partial "appuser"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%G\" \"/var/log/kafka\""
#     assert_output --partial "root"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "ls -ld /var/log/kafka"
#     assert_output --partial "drwxrwxrw-"
# }

# @test "/var/log/confluent should be owned by appuser:root and have 770 permissions" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/var/log/confluent\""
#     assert_output --partial "appuser"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%G\" \"/var/log/confluent\""
#     assert_output --partial "root"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "ls -ld /var/log/confluent"
#     assert_output --partial "drwxrwxrw-"
# }

# @test "/var/lib/kafka should be owned by appuser:root and have 770 permissions" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/var/lib/kafka\""
#     assert_output --partial "appuser"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%G\" \"/var/lib/kafka\""
#     assert_output --partial "root"
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "ls -ld /var/lib/kafka"
#     assert_output --partial "drwxrwxrw-"
# }

# @test "/etc/zookeeper/secrets should be a volume" {
#     run bash -c "$BATS_BUILD_TOOL inspect ${BATS_IMAGE} | jq -c '.[0].Config.Volumes'"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker\""
#     assert_output --partial "appuser"
# }

# @test "/etc/confluent/docker/configure should exist, be owned by appuser, and match the source file" {
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/configure\""
#     assert_output --partial "appuser"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/ensure\""
#     assert_output --partial "appuser"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/launch\""
#     assert_output --partial "appuser"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/log4j.properties.template\""
#     assert_output --partial "appuser"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/myid.template\""
#     assert_output --partial "appuser"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/run\""
#     assert_output --partial "appuser"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/tools-log4j.properties.template\""
#     assert_output --partial "appuser"
...
#     run unbuffer $BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} /bin/bash -c "stat -c \"%U\" \"/etc/confluent/docker/zookeeper.properties.template\""
#     assert_output --partial "appuser"
...
#     run unbuffer bash -c "$BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} whoami" 3>&-
#     assert_output --partial "appuser"
# }

# @test "pwd should be /home/appuser/" {
#     run unbuffer bash -c "$BATS_BUILD_TOOL exec -it cp-zookeeper-test-${ARCH} pwd" 3>&-
...
# @test "krb5 data should be a volume" {
